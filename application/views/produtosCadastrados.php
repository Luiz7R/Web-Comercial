 ...
 <script>
  ...
  $(function(){
  		...
  		$('#novoProduto').click(function(){
  			...
  			$('#myForm').attr('action', '../../admin/addProdutos');
  		});
  ...
  // editar produto
  	 $('#showdata').on('click', '.item-edit', function(){
  	 	 ...
  	 	 $('#myForm').attr('action', '<?php echo base_url() ?>index.php/admin/updateProdutos');
  	 	 $.ajax({
  	 	 	type: 'ajax',
  	 	 	method: 'get',
  	 	 	url: '<?php  echo base_url( ) ?>index.php/admin/EditarProdutos',
  	 	 	data: {id: id},
  	 	 	async: false,
  	 	 	dataType: 'json',
  	 ...
  	 $('#showdata').on('click', '.item-delete', function(){
  	 	 ...
  	 	 $('#btnDeletar').unbind( ).click(function(){
  	 	 	 $.ajax({
	  	 	 	...
	  	 	 	method: 'get',
	  	 	 	async: false,
	  	 	 	url: '<?php  echo base_url( ) ?>index.php/admin/deletarProduto',
	  	 	 	data: {id: id},
	  	 	 	dataType: 'json',
	  	 	 	success: function(response){
	  	 	 		if(response.success){
